#
#  Be sure to run `pod spec lint KIFormRequest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/smartwalle/KIFormRequest.git", :tag => "0.1" }
  ...
  s.source_files  = "KIFormRequest/KIFormRequest/**/*.{h,m}"
